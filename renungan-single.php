...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">GMIT Lahairoi Tuak Sabu</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Tentang</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="tentang.php">Profil Gereja</a></li>
              <li><a href="profil-pendeta.php" class="active">Profil Pendeta</a></li>
          ...
          <!-- <li><a href="login.php" class="getstarted">Masuk</a></li> -->
        </ul>

...
<body>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h4>GMIT Lahairoi Tuak Sabu Lasiana</h4>
              <p>
                Jalan Timor Raya, Lasiana, Kota Kupang<br>
                Nusa Tenggara Timur<br><br>
                <strong>Telepon :</strong> +62 822 3787 3925<br>
                <strong>Email :</strong> lahairoituaksabu@gmail.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>GMIT Lahairoi Tuak Sabu Lasiana</span></strong>.
      </div>
    </div>
  </footer><!-- End Footer -->

      ...
      <section class="statistics">
        <div class="container-fluid">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Master <li class="breadcrumb-item active">Posting Profil Pegawai</li> </li>
          </ul>
          ...
          <div class="row d-flex">
            <div class="col-lg-12">
                ...
                <div class="form-group row has-success">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="txtnama" class="form-control is-valid" placeholder="Nama Pegawai">
                      </div>
                </div>
                  <div class="form-group row has-success">
                      <label class="col-sm-2 form-control-label">Jabatan</label>
                      <div class="col-sm-10">
                        <input type="text" name="txtjabatan" class="form-control is-valid" placeholder="jabatan">
                      </div>
                </div>
                    <div class="form-group row has-success">
                ...
                <input type="submit" name="btnsimpan" class="btn btn-primary" value="Posting Profil Pendeta">
                        ...
                        <?php
                                ...
                                $simpan = mysqli_query($konek,"INSERT INTO tbl_pegawai (nama,jabatan,gambar) VALUES ('$txtnama','$txtjabatan','$nama_file')");

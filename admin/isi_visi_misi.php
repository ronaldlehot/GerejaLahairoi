...
<ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Master <li class="breadcrumb-item active">Ubah Visi Misi</li> </li>
</ul>
			...
			<div class="col">
				<div class="card shadow">
					...
					<div class="card-body">
						...
						<?php endif; ?>
						<form method="POST" action="proses_visimi.php">
							<div class="form-group">
								<textarea name="isi_visi_misi" id="ckeditor" class="ckeditor form-control" style="height: 300px;"><?= $visimi['isi_visi_misi'] ?></textarea>
							</div>
							<div class="form-group">
